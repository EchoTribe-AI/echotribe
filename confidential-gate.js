(function () {
  ...
  style.textContent = [
    ...
    '#et-gate-box{background:#fff;border-radius:16px;max-width:560px;width:100%;padding:40px 44px;box-shadow:0 8px 48px rgba(20,6,14,0.22);font-family:"Inter",system-ui,sans-serif;color:#4a2135;}',
    ...
    '#et-gate-box h2{font-family:"Outfit",sans-serif;font-size:26px;font-weight:700;line-height:1.2;margin-bottom:18px;color:#2a0d1e;}',
    ...
    '#et-gate-btn{width:100%;padding:14px 0;background:#b7004d;color:#fff;font-family:"Inter",system-ui,sans-serif;font-size:15px;font-weight:700;border:none;border-radius:10px;cursor:pointer;opacity:.45;pointer-events:none;transition:opacity .2s,background .2s;}',
